...
CREATE TABLE IF NOT EXISTS `CAR_RENTAL`.`PERSON` (
  ...
  `PERSON_MNAME` VARCHAR(15),
  `PERSON_STREET` VARCHAR(20),
  `PERSON_CITY` VARCHAR(15),
  `PERSON_STATE` VARCHAR(2),
  `PERSON_ZIPCODE` varchar(5),
  `PERSON_DOB` varchar(50) not null,
  `PERSON_AREACODE` varchar(3),
  `PERSON_PHONE` varchar(255),
  `PERSON_USERNAME` VARCHAR(30) NOT NULL,
  `PERSON_PASSWORD` VARCHAR(50) NOT NULL,
  `PERSON_EMAILID` VARCHAR(30),
  `PERSON_EMAILDOMAIN` VARCHAR(20),
  `PERSON_GENDER` VARCHAR(20),
  `PERSON_TYPE` VARCHAR(1) NOT NULL default "C",
